...
assessmentButton.addEventListener(
  ...
  () => { // 無名関数でアロー関数
    ...
    //headerDivisionにbodyDivisionをresultDivisionに差し込む
    ...
    anchor.setAttribute('data-text', result); //診断結果の追加
